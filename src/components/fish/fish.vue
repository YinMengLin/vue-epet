<template>
  <div>
    ...
    <div class="header">
      ...
      <div class="tabs-fish" ref="tabsWrap">
        <Menu mode="horizontal"  active-name="f1">
          <Menu-item name="f1">
            水族首页
          </Menu-item>
          <Menu-item name="f2">
      ...
      .ivu-menu
        ...
        .ivu-menu-item
          ...
          &.ivu-menu-item-active
            border-bottom 3px solid #039ddf
