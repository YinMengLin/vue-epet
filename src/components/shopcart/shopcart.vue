    ...
    <div class="shopcart-wrap">
      ...
      <div class="mycart">
        <div class="emptycart">
          ...
          <div class="emptycart-text">购物车是空的</div>
          <div class="emptycart-btn">
            <a href="javascript:;" class="btn-l">去逛逛</a>
